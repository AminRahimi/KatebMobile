...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = 'app/lib/vtPDFSignable/web/images/';
  PDFJS.workerSrc = 'app/lib/vtPDFSignable/build/pdf.worker.js';
  PDFJS.cMapUrl = 'app/lib/vtPDFSignable/web/cmaps/';
...
var PDFViewerApplication = {
  ...
  zoomIn: function pdfViewZoomIn(ticks) {
    vtPDFSrvc = angular.element(document).injector().get('vtPDFSrvc');
...
window.addEventListener('pagechange', function pagechange(evt) {
  ...
  if (evt.previousPageNumber !== page) {
    localStorage.setItem("pdfPageNumber", page);
...
function webViewerLoad() {
  vtPDFSrvc = angular.element(document).injector().get('vtPDFSrvc');
  vtPDFSrvc.initVtPDF = function () {
    DEFAULT_URL = vtPDFSrvc.getPDFUrl();
  }
