angular.module('persianDate', []).filter('persianDate', function($locale, PersianDateService) {
	...
	this.getFullWatch = function(date){
		var miliseconds = date.getTime();
		var seconds = parseInt(miliseconds / 1000);
		var minutes = parseInt(seconds / 60);
		var hours = parseInt(minutes / 60);
		var humanMinutes = minutes - hours*60;
		var humanSeconds = seconds - minutes*60;
		return (hours + ':' + humanMinutes + ':' + humanSeconds);
	};
