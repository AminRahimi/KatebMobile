...
//   FIXME:accordion-group template is changed instead of ussing new version that accept template
angular.module("template/accordion/accordion-group.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/accordion/accordion-group.html",
    "<div class=\"accordion-group {{panelClass || ''}}\">\n" +
    "  <div class=\"accordion-group__heading\" ng-keypress=\"toggleOpen($event)\">\n" +
    "    <h5 class=\"accordion-group__title\">\n" +
    "      <a href tabindex=\"0\" class=\"accordion-toggle\" ng-click=\"toggleOpen()\" accordion-transclude=\"heading\"><span class=\"accordion-group__title-text\" ng-class=\"{'text-muted': isDisabled}\">{{heading}}</span></a>\n" +
    "    </h5>\n" +
    "  </div>\n" +
    "  <div class=\"accordion-group__collapse collapse\" collapse=\"!isOpen\">\n" +
    "	  <div class=\"accordion-group__body\" ng-transclude></div>\n" +
    "  </div>\n" +
    "</div>\n" +
    "");
}]);
//   FIXME:accordion template is changed instead of ussing new version that accept template
