...
self.TrackJS = self.trackJs = (function (g, l, n) {
  ...
  q.prototype = {
    current: {},
    initOnly: { application: !0, cookie: !0, enabled: !0, token: !0, callback: { enabled: !0 }, console: { enabled: !0 }, navigation: { enabled: !0 }, network: { enabled: !0, fetch: !0 }, visitor: { enabled: !0 }, window: { enabled: !0, promise: !0 } },
    defaults: {
      application: "",
      cookie: !1,
      dedupe: !0,
    ...
    initCurrent: function (a) {
      this.removeEmpty(a);
      if (this.validate(a, this.defaults, "[TrackJS] config", {})) return (this.current = c.defaultsDeep({}, a, this.defaults)), !0;
      this.current = c.defaultsDeep({}, this.defaults);
      return !1;
    },
    setCurrent: function (a) {
      return this.validate(a, this.defaults, "[TrackJS] config", this.initOnly) ? ((this.current = c.defaultsDeep({}, a, this.current)), !0) : !1;
    },
      ...
      for (var c in a)
        if (a.hasOwnProperty(c))
          if (b.hasOwnProperty(c)) {
            var g = typeof b[c];
            g !== typeof a[c] ? (console.warn(d + "." + c + ": property must be type " + g + "."), (f = !1)) : "[object Array]" !== Object.prototype.toString.call(a[c]) || this.validateArray(a[c], b[c], d + "." + c) ? ("[object Object]" === Object.prototype.toString.call(a[c]) ? (f = this.validate(a[c], b[c], d + "." + c, e[c])) : e.hasOwnProperty(c) && (console.warn(d + "." + c + ": property cannot be set after load."), (f = !1))) : (f = !1);
  ...
  w.prototype = {
    ...
    report: function () {
      return { age: new Date().getTime() - this.loadedOn, dependencies: this.config.current.dependencies ? this.discoverDependencies() : { trackJs: "3.10.1" }, originalUrl: this.originalUrl, referrer: this.referrer, userAgent: g.navigator.userAgent, viewportHeight: c.isBrowser ? g.document.documentElement.clientHeight : 0, viewportWidth: c.isBrowser ? g.document.documentElement.clientWidth : 0 };
    },
  };
  var x = function (a) {
    this.util = a;
  ...
  z.prototype = {
        ...
        return function (h, p) {
          ...
          return l
            ...
            ["catch"](function (a) {
              a = a || {};
              var f = b.get("n", l.__trackjs_state__);
              f && (c.defaults(f, { completedOn: c.isoNow(), statusCode: 0, statusText: a.toString() }), d.error && (e("ajax", { name: a.name, message: (a.message || "Failed") + ": " + f.method + " " + f.url, stack: a.stack || k }), (a.__trackjs_state__ = !0)));
              throw a;
            });
        };
      });
    ...
    finalizeNetworkEvent: function (a) {
      if (a._trackJs) {
        ...
        b && ((b.completedOn = this.util.isoNow()), a.getAllResponseHeaders && a.getResponseHeader && 0 <= (a.getAllResponseHeaders() || "").toLowerCase().indexOf("trackjs-correlation-id") && (b.requestCorrelationId = a.getResponseHeader("trackjs-correlation-id")), (b.statusCode = 1223 == a.status ? 204 : a.status), (b.statusText = 1223 == a.status ? "No Content" : a.statusText));
      }
    },
  ...
  t.prototype = {
    ...
    getCORSRequest: function (a, b) {
      var d;
      this.util.testCrossdomainXhr() ? ((d = new g.XMLHttpRequest()), d.open(a, b), d.setRequestHeader("Content-Type", "text/plain")) : "undefined" !== typeof g.XDomainRequest ? ((d = new g.XDomainRequest()), d.open(a, b)) : (d = null);
      return d;
    },
  ...
  A.prototype = {
    ...
    matchInputPattern: function (a) {
      return "" === a
        ...
        ? "date"
        : /^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*(?:#|x\.?|ext\.?|extension)\s*(\d+))?$/.test(a)
        ? "usphone"
        : /^\s*$/.test(a)
        ? "whitespace"
        : /^\d*$/.test(a)
    ...
    onError: (function () {
      ...
      return function (d, e, f) {
        if (this.hasInstalled && this.hasEnabled && c.isBrowserSupported())
          try {
            if (((f = f || { bindStack: null, bindTime: null, force: !1 }), (e && c.isError(e)) || (e = { name: "Error", message: this.serialize(e, f.force) }), -1 === e.message.indexOf("TrackJS Caught")))
